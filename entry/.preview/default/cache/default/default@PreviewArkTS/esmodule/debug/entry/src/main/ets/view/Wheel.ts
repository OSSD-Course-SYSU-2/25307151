...
export class Wheel extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/Wheel.ets(165:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 当前选项显示框
            Column.create();
            Column.debugLine("entry/src/main/ets/view/Wheel.ets(167:7)", "entry");
            // 当前选项显示框
            Column.width('80%');
            // 当前选项显示框
            Column.height(60);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/Wheel.ets(168:9)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/Wheel.ets(181:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Canvas.debugLine("entry/src/main/ets/view/Wheel.ets(182:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 指针
            Column.create();
            Column.debugLine("entry/src/main/ets/view/Wheel.ets(192:9)", "entry");
            // 指针
            Column.width(4);
            // 指针
            Column.height(40);
            ...
            if (this.selectedIndex >= 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/Wheel.ets(204:9)", "entry");
                        Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 开始按钮
            Button.createWithLabel(this.isSpinning ? '旋转中...' : '开始抽奖');
            Button.debugLine("entry/src/main/ets/view/Wheel.ets(212:7)", "entry");
            // 开始按钮
            Button.width('60%');
            // 开始按钮
            Button.height(50);
            ...
            Button.fontSize(18);
            // 开始按钮
            Button.backgroundColor(this.isSpinning ? '#CCCCCC' : { "id": 16777262, "type": 10001, params: [], "bundleName": "com.example.animation", "moduleName": "entry" });
            // 开始按钮
            Button.fontColor(Color.White);
            // 开始按钮
            Button.margin({ top: 30 });
            // 开始按钮
            Button.enabled(!this.isSpinning);
            // 开始按钮
            Button.onClick(() => {
                this.spin();
            });
